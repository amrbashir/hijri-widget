...
val keystoreFilePath = System.getProperty("KEYSTORE_FILE_PATH")
val hasSigningConfig =
	listOf(
		keystoreFilePath,
		System.getProperty("KEYSTORE_PASSWORD"),
		System.getProperty("KEY_ALIAS"),
...
tasks.register<GenerateContributorsTask>("generateGitHubContributors") {
	...
	outputFile.set(
		layout.buildDirectory.file(
			"generated/source/contributors/me/amrbashir/hijriwidget/Contributors.kt",
		),
	)
...
tasks.register<GenerateChangelogTask>("generateChangelogFile") {
	...
	packageName.set("me.amrbashir.hijriwidget")
	outputFile.set(
		layout.buildDirectory.file("generated/source/changelog/me/amrbashir/hijriwidget/Changelog.kt"),
	)
}
